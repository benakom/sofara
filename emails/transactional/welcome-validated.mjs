...
export default {
  ...
  blocks: {
    en: [
      ...
      ["p", "**How much do I earn, and when?** Up to 3% of the property value, depending on the developer (for example Emaar and Sobha 3%, DAMAC 2.5%). The commission is earned once the client signs the SPA and pays the down payment with the DLD fees, then paid in AED by bank transfer within 7 days of the developer's payment to Cevitas, against an invoice you issue from your dashboard. No fee, no subscription."],
    ...
    fr: [
      ...
      ["p", "**Combien je gagne, et quand ?** Jusqu'à 3 % de la valeur du bien, selon le promoteur (par exemple Emaar et Sobha 3 %, DAMAC 2,5 %). La commission est acquise une fois que le client signe le SPA et règle l'apport avec les frais DLD, puis versée en AED par virement sous 7 jours après le paiement du promoteur à Cevitas, contre une facture émise depuis votre tableau de bord. Aucun frais, aucun abonnement."],
