...
const AdminLeads = () => {
  ...
  const scoreBadge = (s: string|null) => { const c: Record<string,string> = {A:"#22C55E",B:"#D2F34C",C:"#F59E0B",D:"#EF4444"}; const color = c[s||"C"]||"#8a8a8a"; return <div className="w-7 h-7 rounded-full border-2 flex items-center justify-center text-[10px] font-bold" style={{borderColor:color,color}}>{s||"C"}</div>; };
