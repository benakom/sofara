                  ...
                  return (
                    <li key={s.key} className="relative flex gap-3 pb-5 last:pb-0">
                      ...
                      <span className={`relative z-10 w-6 h-6 rounded-full flex items-center justify-center shrink-0 border ${
                        done ? "bg-[hsl(var(--dash-accent))] border-[hsl(var(--dash-accent))] text-black"
                        : active ? "bg-[hsl(var(--dash-card))] border-[hsl(var(--dash-accent))] text-[hsl(var(--dash-accent))] shadow-[0_0_0_4px_hsl(var(--dash-accent)/.15)]"
                      ...
                      <div className="min-w-0 flex-1 pt-0.5">
                        ...
                        {active && <p className="text-[11px] text-[hsl(var(--dash-accent))] mt-0.5">{isFr ? "Étape en cours, mise à jour par l'équipe Sofara" : "Current stage, updated by the Sofara team"}</p>}
                      </div>
                    </li>
                  );
                })}
                ...
                return (
                  <div key={c.id} className="rounded-xl border border-[hsl(var(--dash-border))] bg-[hsl(var(--dash-card))] p-4 mb-3">
                    <div className="flex items-start justify-between gap-3">
                      ...
                      <span className="text-[11px] font-semibold px-2 py-1 rounded-md shrink-0" style={st.order === 0 ? { background: "hsl(38 92% 50% / .12)", color: "hsl(38 92% 60%)" } : { background: "hsl(var(--dash-accent) / .12)", color: "hsl(var(--dash-accent))" }}>
