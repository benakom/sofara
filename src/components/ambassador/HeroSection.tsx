    ...
    <section className="relative min-h-[100svh] overflow-hidden flex items-center">
      ...
      <div className="relative z-10 w-full px-5 sm:px-6 pt-24 sm:pt-28 pb-16 sm:pb-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <h1 className="font-display text-[2rem] leading-[1.1] sm:text-5xl lg:text-7xl xl:text-8xl font-bold tracking-tight mb-6 sm:mb-8">
              <span className="text-foreground">{t("hero.slide1.headline")}</span>
            </h1>

            <p className="text-base sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-10 sm:mb-12 leading-relaxed px-2">
              {t("hero.slide1.sub")}
            </p>
