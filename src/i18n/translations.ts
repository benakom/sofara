...
export const translations: Record<Lang, Record<string, string>> = {
  fr: {
    ...
    "hero.slide3.sub": "0% d'impôt, rendements locatifs de 8 à 12%, +32% de transactions en 2024. Le moment est maintenant.",
    "hero.cta": "Devenir Ambassadeur",
    "hero.ctaSecondary": "Voir la démo",
    "hero.trust": "Rejoignez 500+ ambassadeurs actifs",
    "hero.metric1": "Commissions versées",
    "hero.metric2": "Ambassadeurs dans 45 pays",
    ...
    "market.titleHighlight": "2024-2025",
    ...
    "market.transactionsSub": "+32% vs 2023 (DLD, 2024)",
    "market.volume": "Volume de transactions",
    "market.volumeSub": "Record historique en 2024",
    "market.units": "Unités vendues en 2024",
    ...
    "market.source": "Sources : Dubai Land Department (DLD), Knight Frank, CBRE, Property Finder — Données 2024/2025",
    ...
    "dubai.description": "Dubai n'est pas juste une ville — c'est une opportunité générationnelle. Avec une croissance de +32% en 2024, 0% d'impôts et des rendements locatifs imbattables, c'est LE marché où vos contacts veulent investir.",
    ...
    "dubai.marketDesc": "+32% de transactions en 2024, une demande qui ne faiblit pas.",
    ...
    "benefits.communityDesc": "Accès à un réseau privé de leaders d'opinion et d'entrepreneurs visionnaires dans 45 pays.",
    ...
    "investor.titleHighlight": "investisseurs",
    "investor.description": "Sofara affiche une croissance exponentielle et des métriques de rétention qui surpassent les standards du marché. Un modèle scalable, asset-light, à forte marge.",
    "investor.paid": "Commissions versées",
    "investor.ambassadors": "Ambassadeurs actifs",
    "investor.countries": "Pays couverts",
    "investor.mrr": "MRR estimé",
    "investor.ltv": "LTV/CAC ratio",
    "investor.ltvTrend": "Best-in-class",
    "investor.conversion": "Temps de conversion",
    "investor.conversionTrend": "Lead → Transaction",
    "investor.cta": "Demander un pitch deck",
    ...
    "testimonials.t1.text": "En 6 mois, j'ai recommandé Sofara à 12 contacts. 4 ont investi. Résultat : plus de €18,000 de commissions. Le système est transparent et ultra simple.",
    ...
    // Footer
    "footer.description": "La première plateforme d'ambassadeurs pour l'immobilier de luxe à Dubai. Technologie, discrétion, performance.",
  ...
  en: {
    ...
    "hero.slide3.sub": "0% tax, rental yields of 8-12%, +32% transactions in 2024. The time is now.",
    "hero.cta": "Become an Ambassador",
    "hero.ctaSecondary": "Watch demo",
    "hero.trust": "Join 500+ active ambassadors",
    "hero.metric1": "Commissions paid out",
    "hero.metric2": "Ambassadors in 45 countries",
    ...
    "market.volumeSub": "All-time record in 2024",
    "market.units": "Units sold in 2024",
    ...
    "market.source": "Sources: Dubai Land Department (DLD), Knight Frank, CBRE, Property Finder — 2024/2025 Data",
    ...
    "dubai.description": "Dubai is not just a city — it's a generational opportunity. With +32% growth in 2024, 0% taxes and unbeatable rental yields, it's THE market where your contacts want to invest.",
    ...
    "dubai.marketDesc": "+32% transactions in 2024, demand keeps rising.",
    ...
    "benefits.communityDesc": "Access to a private network of thought leaders and visionary entrepreneurs in 45 countries.",
    ...
    "investor.titleHighlight": "investors",
    "investor.description": "Sofara shows exponential growth and retention metrics that surpass market standards. A scalable, asset-light, high-margin model.",
    "investor.paid": "Commissions paid out",
    "investor.ambassadors": "Active ambassadors",
    "investor.countries": "Countries covered",
    "investor.mrr": "Estimated MRR",
    "investor.ltv": "LTV/CAC ratio",
    "investor.ltvTrend": "Best-in-class",
    "investor.conversion": "Conversion time",
    "investor.conversionTrend": "Lead → Transaction",
    "investor.cta": "Request a pitch deck",
    ...
    "testimonials.t1.text": "In 6 months, I referred Sofara to 12 contacts. 4 invested. Result: over €18,000 in commissions. The system is transparent and ultra simple.",
    "testimonials.t2.name": "Sarah M.",
    ...
    // Footer
    "footer.description": "The first ambassador platform for luxury real estate in Dubai. Technology, discretion, performance.",
