...
<p>Les cookies peuvent être supprimés automatiquement à la fin de session ou rester pour une durée limitée selon leur finalité.</p>`,
  ...
  en: {
    ...
    "hero.slide1.headline": "Dubai real estate.\nYour next income stream.",
    "hero.slide1.sub": "Become a Sofara ambassador and earn exceptional commissions on every Dubai property transaction. No license required.",
...
<p>Cookies may be automatically deleted at the end of a session or remain for a limited period depending on their purpose.</p>`,
  ...
  ar: {
    ...
    "hero.slide1.headline": "عقارات دبي.\nمصدر دخلك القادم.",
    "hero.slide1.sub": "كن سفيراً لسوفارا واحصل على عمولات استثنائية على كل صفقة عقارية في دبي. لا حاجة لرخصة.",
    ...
    "faq.a3": "العمولات تتراوح من 9,200€ إلى 30,000€ لكل صفقة حسب العقار. أفضل سفرائنا يتجاوزون 5,000€/شهر.",
  ...
  es: {
    ...
    "hero.slide1.headline": "Inmobiliaria en Dubái.\nTu próxima fuente de ingresos.",
    "hero.slide1.sub": "Conviértete en embajador de Sofara y gana comisiones excepcionales en cada transacción inmobiliaria en Dubái. Sin licencia requerida.",
  ...
  ru: {
    ...
    "hero.slide1.headline": "Недвижимость Дубая.\nВаш следующий источник дохода.",
    "hero.slide1.sub": "Станьте амбассадором Sofara и получайте исключительные комиссионные с каждой сделки с недвижимостью в Дубае. Лицензия не требуется.",
    ...
    "faq.a3": "Комиссионные от 9 200€ до 30 000€ за сделку в зависимости от объекта. Лучшие амбассадоры превышают 5 000€/мес.",
