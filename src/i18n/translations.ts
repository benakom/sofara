...
export const translations: Record<Lang, Record<string, string>> = {
  fr: {
    ...
    "benefits.commissionsDesc": "Gagnez jusqu'à 3% sur chaque bien vendu via vos recommandations. Sans plafond, sans limite.",
...
<p>Les cookies peuvent être supprimés automatiquement à la fin de session ou rester pour une durée limitée selon leur finalité.</p>`,
  ...
  en: {
    ...
    "benefits.commissions": "Commission up to 3%",
    "benefits.commissionsDesc": "Earn up to 3% on every property sold through your referrals. No cap, no limit.",
