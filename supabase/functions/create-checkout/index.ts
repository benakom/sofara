// Creates a Stripe Checkout session for a Sofara Pro subscription (monthly or yearly).
import { corsHeaders, json, getStripe, getAuthUser, findCustomer, getOrCreatePrice, originFrom, type Plan } from "../_shared/stripe.ts";
