...
-- 1. Fix KYC status tampering: replace user UPDATE policy with WITH CHECK that locks status to 'pending'
...
-- 2. Fix get_profile_status RPC enumeration: add auth.uid() guard
